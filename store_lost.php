...
// Rename the image with L_ID
$sql = "INSERT INTO Lost_item (USER_ID, L_NAME, DESCRIPTION, LOCATION, DATE_TIME) VALUES ('$id', '$item_name', '$description', '$location', '$datetime')";
if ($conn->query($sql) === TRUE) {
    $last_id = $conn->insert_id;
    $newFileName = $target_dir . "L_" . $last_id . "." . $imageFileType;
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $newFileName)) {
        ...
        header("refresh:2;url=lost_upload.php?registrationSuccessful=true");
    } else {
